...
class Version20141028075227 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE smq_message (id INT AUTO_INCREMENT NOT NULL, queue_id INT DEFAULT NULL, retries_remaining INT NOT NULL, created_at DATETIME NOT NULL, available_at DATETIME NOT NULL, timeout_at DATETIME DEFAULT NULL, token VARCHAR(100) DEFAULT NULL, body LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_6851D3235F37A13B (token), INDEX IDX_6851D323477B5BAE (queue_id), INDEX idx_available_at (queue_id, available_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
