...
class Version20141028075227 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE smq_message (id INT AUTO_INCREMENT NOT NULL, queue_id INT DEFAULT NULL, retriesRemaining INT DEFAULT NULL, createdAt DATETIME NOT NULL, takenAt DATETIME DEFAULT NULL, timeoutAt DATETIME DEFAULT NULL, completedAt DATETIME DEFAULT NULL, token VARCHAR(100) NOT NULL, body LONGTEXT NOT NULL, INDEX IDX_6851D323477B5BAE (queue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE smq_project_role (user_id INT NOT NULL, project_id INT NOT NULL, roles LONGTEXT NOT NULL COMMENT '(DC2Type:array)', INDEX IDX_E8924F3BA76ED395 (user_id), INDEX IDX_E8924F3B166D1F9C (project_id), PRIMARY KEY(user_id, project_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE smq_user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, createdAt DATETIME NOT NULL, lastLogin DATETIME DEFAULT NULL, salt LONGTEXT NOT NULL, password LONGTEXT NOT NULL, roles LONGTEXT NOT NULL COMMENT '(DC2Type:array)', token VARCHAR(120) DEFAULT NULL, tokenCreatedAt DATETIME DEFAULT NULL, locale VARCHAR(16) NOT NULL, timezone VARCHAR(32) NOT NULL, pictureUrl VARCHAR(120) NOT NULL, UNIQUE INDEX UNIQ_7B76EB14E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
